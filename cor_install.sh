...
ADMIN_EMAIL="erp.tech.2022@gmail.com"
...
sudo -H pip3 install -r https://raw.githubusercontent.com/erp-texh-2022/ERP_14c_source/14.0/requirements.txt
...
sudo git clone --depth 1 --branch $OE_VERSION https://github.com/erp-texh-2022/ERP_14c_source $OE_HOME_EXT/
